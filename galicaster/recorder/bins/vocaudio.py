...
#
#       galicaster/recorder/bins/vocaudio
#
...
pipestr = (' tcpclientsrc name=gc-audio-src host=localhost port=11000 ! queue ! matroskademux ! '
...
class GCvocaudio(Gst.Bin, base.Base):
